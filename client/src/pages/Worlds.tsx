...
const Worlds = (props: any): JSX.Element => {
  ...
  return (
    <>
      <div onClick={(e) => navigate('/level6')} className='bg-transparent w-4 h-4 absolute scale-[7.5] left-[15.49rem] top-[5rem] rounded-xl z-10 cursor-pointer'></div>
      <div onClick={(e) => navigate('/level5')} className='bg-transparent w-4 h-4 z-10 top-[13rem] scale-[5] left-[10rem] rounded-xl absolute'></div>
      <div onClick={(e) => navigate('/level4')} className='bg-transparent w-4 h-4 z-10 top-[18rem] scale-[6] left-[21rem] rounded-xl absolute'></div>
      <div onClick={(e) => navigate('/level3')} className='bg-transparent w-4 h-4 z-10 top-[27rem] scale-[7.2] left-[17.3rem] rounded-xl absolute'></div>
      <div onClick={(e) => navigate('/level2')} className='bg-transparent w-4 h-4 z-10 top-[33rem] scale-[5] left-[9.3rem] rounded-xl absolute'></div>
      <div onClick={(e) => navigate('/level1')} className='bg-transparent w-4 h-4 z-10 top-[42rem] left-[4.5rem] scale-[5] rounded-xl absolute'></div>

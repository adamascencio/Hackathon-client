...
export const ProfileDailyChallenge = () => {
  return (
    ...
    <div className='flex flex-col items-center relative'>
      ...
      <div id='dc' className="flex items-center justify-end w-[22rem] h-[6rem] border-[1px] rounded-3xl shadow-xl opacity-70">
        <img src={dcPlanet} alt='planet' className='mr-8'></img>
      </div>
    </div>
    </>
  )

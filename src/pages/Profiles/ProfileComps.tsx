...
export const ProfileDailyChallenge = () => {
  return (
    ...
    <div className='flex flex-col items-center'>
        <div className=" w-[22rem] h-[6rem] border-gray-400 border-[1px] rounded-3xl shadow-xl"><h1 className='text-lg pl-4 pt-1 font-bold'>Daily Challenge</h1></div>
    </div>
    </>
  )
}
...
export const ProfileFeaturedGames = () => {
  ...
  export const ProfileMathByTopic = () => {
    return (
      <>
    <div className='flex flex-col'>
        <h1 className='text-lg pl-4 pt-1 font-bold'>Math by topic</h1>
        <div className='flex justify-evenly'>
